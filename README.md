...
##### С кодированием в mJPEG на уровне хоста

В таблице описаны результаты экспериментов с кодированием H264- и VP9-файлов в mJPEG на уровне хоста и передачей именно mJPEG-потока по сети на эмулятор с выводом изображения на экран.

| Данные | Нагрузка на хосте| | Нагрузка на эмуляторе | | Комментрии |
|  :---:  |    :---:        |:---:|           :---:   |:---:|---|
|         | `VirtualBox` | `gst-launch` | `gst-launch` | `lipstick` |
| H264 | 160% | 35% | 85% | 20% | Артефактов нет и при битрейте выше 15 кадров в секунду.
| VP9 | 170% | 50% | 90% | 23% | Картинка не тормозит. Артефактов и задержек нет.
